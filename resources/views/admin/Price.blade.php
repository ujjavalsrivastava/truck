													...
													<div class="col-xl-4">
														<div class="d-flex h-100 align-items-center">
															...
															<div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
																...
																<!--end::Heading-->
																<!--begin::Features-->
																<div class="w-100 mb-10" style="text-align:center">
																	<!--begin::Item-->
																...
																<!--end::Features-->
																<!--begin::Select-->
																<a href="javascript:void(0)" onclick="subscriptionFun()" class="btn btn-sm btn-primary">Select</a>
																<!--end::Select-->
															</div>
															<!--end::Option-->
														</div>
...
async function subscriptionFun(){
	...
	const body = {
		...
		const response = await axios.put("{{ env('BASEURL').'dealer/profile' }}", body, {
