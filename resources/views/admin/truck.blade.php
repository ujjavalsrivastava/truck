...
@section('content')
	...
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0"> Trucks List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													<!--begin::Add customer-->
													<a href="{{url('admin/truck-list/create')}}"  class="btn btn-primary" >Add Truck </a>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
...
document.addEventListener("DOMContentLoaded", function () {
 ...
 <div class="dropdown btn btn-sm btn-light btn-flex btn-center btn-active-light-primary px-0">
  ...
  if (result.isConfirmed) {
	const response = await axios.delete("{{ env('BASEURL').'dealer/trucks/' }}"+_id,  {
            headers: { "Authorization": `Bearer ${localStorage.getItem("access_token")}` }
        });
