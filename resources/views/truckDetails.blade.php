                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-5 d-lg-flex d-none align-items-center justify-content-end">
                            <div class="banner-img">
                                <img src="{{asset('assets/img/inner-page/car-dt-banner-img.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="swiper product-img-slider">
                                                <div class="swiper-wrapper">
                                                    ...
                                                    @php   
                                                $transformation = "c_fill,h_404,w_736"; 
                                               $img = modifyCloudinaryUrl($row,$transformation)
                                                @endphp
                ...
                <div class="col-lg-4">
                    <div class="car-details-sidebar">
                        ...
                        <div class="inquiry-form mb-40">
                            ...
                            <form id="quoteForm">
                                <input type="hidden" name="truckId" value="{{$_id}}">
                                <div class="form-inner mb-20">
                                    <label>Name*</label>
                                    <input type="text" name="buyerName" placeholder="Ex- Jhon Numan">
                                </div>
                                <div class="form-inner mb-20">
                                    <label>Email*</label>
                                    <input type="email" name="buyerEmail" placeholder="Ex- info@gmail.com">
                                </div>
                                <div class="form-inner mb-20">
                                    <label>Phone</label>
                                    <input id="phone" name="buyerPhone" type="tel" name="phone" />
                                </div>
                                <div class="form-inner mb-20">
                                    <label>Message*</label>
